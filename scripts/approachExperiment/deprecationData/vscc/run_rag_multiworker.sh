...
GENERATED_QUERIES_FILE="data/generated_queries/versibcb_vscc_queries_with_code_review_filtered.json"
...
# QA缓存上下文
QACacheContext_path="data/temp/inference/versibcb_vscc_results_code_review_extrainfo.jsonl"
...
# error_fix
ERROR_INFO_FILEPATH="data/temp/combined_errors_vscc_depre_new.json"
# # 自定义输出路径
