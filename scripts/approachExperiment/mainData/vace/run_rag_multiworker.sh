...
if [ -f ".env" ]; then
    ...
    echo "Please create a .env file with the required paths"
    exit 1
fi
...
MODEL="${LLAMA_INSTRUCT_PATH}" # codegemma-7b-it/Llama-3.1-8B
KNOWLEDGE_TYPE="docstring"
PRECISION="fp16"
LOCAL_EMBEDDING_MODEL="all-MiniLM-L6-v2"
TOGETHERAI_EMBEDDING_MODEL="togethercomputer/m2-bert-80M-32k-retrieval"
RAG_COLLECTION_BASE="${RAG_DATA_PATH}/chroma_data"
DOCSTRING_EMBEDDING_BASE_PATH="${RAG_DATA_PATH}/docs_embeddings"
SRCCODE_EMBEDDING_BASE_PATH="${RAG_DATA_PATH}/srccodes_embeddings"
...
# 对于doc的压缩
MAX_DOC_TOKENS=200
DOC_TRUNCATE_TOKENIZER="/path/to/models/Llama-3.1-8B"
# 对于API名称字符串匹配
