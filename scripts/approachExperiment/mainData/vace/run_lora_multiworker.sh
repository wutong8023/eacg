...
TOP_P=0.95
PRECISION="fp16"
MODEL_NAME="${MODELS_PATH}/CodeLlama-13b-Instruct-hf"
KNOWLEDGE_TYPE="docstring"
ADAPTOR_BASE_PATH="${MODELS_PATH}/loraadaptors/"
MERGED_ADAPTOR_PATH="${MODELS_PATH}/loraadaptors/merged_lora_model1"
BASE_OUTPUT_DIR="output/approach_eval/"
FORCE_GPU=false  # 默认不强制使用GPU
